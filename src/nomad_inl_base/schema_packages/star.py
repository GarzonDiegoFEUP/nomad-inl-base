...
StarThinFilm = INLThinFilm


# StarSubstrate and StarSubstrateReference are now defined in entities.py
# as INLSubstrate and INLSubstrateReference (shared with wet deposition).
# These aliases keep existing NOMAD archive references working.
StarSubstrate = INLSubstrate
StarSubstrateReference = INLSubstrateReference


StarThinFilmReference = INLThinFilmReference
StarStack = INLThinFilmStack
StarStackReference = INLThinFilmStackReference
